...
class SemanticSegmentationCamera():
    ...
    def __init__(self, vehicle):
        ...
        self.sensor.listen(
            lambda image: SemanticSegmentationCamera._get_front_camera_data(weak_self, image))
...
class RgbCamera:
    ...
    def __init__(self, vehicle):
        ...
        self.sensor = self._set_camera_sensor(world)
        weak_self = weakref.ref(self)
        self.sensor.listen(lambda image: RgbCamera._get_third_person_camera(weak_self, image))
