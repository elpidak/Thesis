...
class VariationalEncoder(nn.Module):
    def __init__(self, latent_dims):  
        ...
        self.directory_model = 'C:/Users/R4A/ThesisCode/code/vae/model/var_encoder_model.pth'
    ...
    def save(self):
        torch.save(self.state_dict(), self.directory_model)

    def load(self):
        self.load_state_dict(torch.load((self.directory_model), map_location=torch.device('cpu')))